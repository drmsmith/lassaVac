...
walk(props, function(.prop_boost) {
    ...
    scenario_name <- paste0(scenario_id, .prop_boost)
    ...
    outbreak_size_adj <- 1                  # outbreak size ranges runif(1-param, 1+param)
...
props <- c(0.9,0.7,0.5)
# suit_vals_new = ifelse(suit_vals > prop_boost, (suit_vals)**2, suit_vals)
